...
$sql = "INSERT INTO customers (id,carID,pass,firstname,lastname,email,carType,PhoneNumber)
VALUES ('$registerID','$registercarID','$registerPassword','$registerFirstName',' $registerLastname','$registerEmail','$cars','$phonenumber')";
