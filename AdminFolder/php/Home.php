...
<body>
    <div style="width:100%;">
        <div class="container-fluid py-4 Today">
            ...
            $data = [
                ["Today", "", ""],
                ["Workers in the shift", 'fa-briefcase', 'SELECT * FROM workers'],
                ["Request in Processing ", 'fa-briefcase', 'SELECT * FROM workers'],
                ["The Next Audi Request Go to ", 'fa-briefcase', 'SELECT * FROM workers'],
                ["The Next BMW Request Go to ", 'fa-briefcase', 'SELECT * FROM workers'],
                ["The Next Skoda Request Go to ", 'fa-briefcase', 'SELECT * FROM workers'],
                ["The Next Mercedes Request Go to ", 'fa-briefcase', 'SELECT * FROM workers'],
                ["The Next Volkswagen Request Go to ", 'fa-briefcase', 'SELECT * FROM workers'],
            ];
