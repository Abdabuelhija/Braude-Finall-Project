...
<body>
  <button type="button" class="Add-Worker" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-plus" aria-hidden="true"></i> Add Product </button><br>
  <!-- Modal -->
      ...
      <div class="modal-content" style="height: 470px;">
        ...
        <div class="modal-body">
            <form method="post" onsubmit="return validateForm()">
              ...
              <input type="text" id="quantity" name="quantity" placeholder=" Product quantity"  class="form-control" required><br>
